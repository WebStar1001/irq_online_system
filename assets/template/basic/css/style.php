...
***/
@import url("https://fonts.googleapis.com/css?family=Comfortaa:300,400,600,700|Overpass:300,400,600,700,800,900&display=swap");
/***
...
height: 100%;
width: 100%;
background-image: radial-gradient(791.1px at 50% 1.82%, #2437bf 0, #001d6d 100%);
content: "";
z-index: -1;
opacity: .9;
}
...
background: #052146;
margin-bottom: 30px;
border: 2px solid #373369;
border-radius: 4px;
}

.sidebar ul li {
border-bottom: 2px solid #373369;
}
...
.dashboard-content .dashboard-inner-content .card:nth-child(odd) .t-log-title {
background: #0865f11a;
}

.dashboard-content .dashboard-inner-content .card:nth-child(even) .t-log-title {
background: #F9F9F9;
}
