                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="dashboard-inner-content">
                                    <div class="card">
                                        <h5 class="card-header">@lang('Request To Me') </h5>
                                        <div class="card-body">
                                                    ...
                                                    @if(count($requestMoney) >0)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-label="@lang('Action')">
                                                                <a href="javascript:void(0);" class="btn btn-dark btn-sm details" data-id="{{encrypt($data->id)}}" data-date="{{date('d M Y H:i A ',strtotime($data->created_at))}}" data-records="{{$data}}" data-toggle="modal" data-target="#myModal"><i class="ti ti-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    @else
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.details').on('click', function () {
                ...
                $('.receive-amount-fee').text(`${data.charge}  ${data.currency.code}`);
