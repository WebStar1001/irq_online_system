                                                ...
                                                <div class="card-body">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text currency_symbol">{{$gateway_currency->baseSymbol()}}</div>
                                                        </div>
                                                        <input type="text" class="form-control" name="currency[{{ $currency_idx }}][min_amount]" value="{{ $gateway_currency->min_amount }}" placeholder="0" required/>
                                                    </div>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="0" name="currency[{{ $currency_idx }}][max_amount]" value="{{ $gateway_currency->max_amount }}" required/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card outline-primary">
                                                ...
                                                <div class="card-body">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="0" name="currency[{{ $currency_idx }}][fixed_charge]" value="{{ $gateway_currency->fixed_charge }}" required/>
                                                    </div>
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="0" name="currency[{{ $currency_idx }}][percent_charge]" value="{{ $gateway_currency->percent_charge }}" required/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card outline-primary">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="0" name="currency[{{ $currency_idx }}][rate]" value="{{ $gateway_currency->rate}}"  required/>
                                                        <div class="input-group-prepend">
