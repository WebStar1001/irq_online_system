        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title mb-3">Gateway Logo</h4>
                        <div class="image-upload">
                            <div class="thumb">
                                <div class="avatar-preview">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="profilePicPreview" style="background-size: 100%;background-image: url({{ get_image(config('constants.logoIcon.path') .'/gateway.png', '?'.time()) }})">
                                                <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="profilePicPreview" style="background-color: #000;background-size: 100%;background-image: url({{ get_image(config('constants.logoIcon.path') .'/gateway.png', '?'.time()) }})">
                                                <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="avatar-edit">
                                    <input type="file" class="profilePicUpload" id="profilePicUpload3" accept=".png" name="gateway">
