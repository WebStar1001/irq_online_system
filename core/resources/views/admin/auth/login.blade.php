                ...
                <form action="{{ route('admin.login') }}" method="POST" class="login-form">
                    ...
                    <div class="login-inner-block">
                        <div class="frm-grp">
                            ...
                            <input type="text" name="username" value="admin" placeholder="Enter your username">
                        </div>
                        <div class="frm-grp">
                            <label>Password</label>
                            <input type="password" name="password" value="admin" placeholder="Enter your password">
                        </div>
                    </div>
