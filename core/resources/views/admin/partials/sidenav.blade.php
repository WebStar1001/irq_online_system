        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ sidenav_active('admin.report*') }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item {{ sidenav_active('admin.report.money-request*')}}">
                        <a class="nav-link" href="{{ route('admin.report.money-request') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Request Money Log</span>
                        </a>
                    </li>

                    <li class="nav-item {{ sidenav_active('admin.report.voucher-log*') }}">
                        <a class="nav-link" href="{{ route('admin.report.voucher-log') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Voucher Log</span>
                        </a>
                    </li>

                    <li class="nav-item {{ sidenav_active('admin.report.invoice-log*')}}">
                        <a class="nav-link" href="{{ route('admin.report.invoice-log') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Invoice Log</span>
                        </a>
                    </li>
        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ sidenav_active('admin.frontend*') }}">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item {{ sidenav_active('admin.frontend.developer*') }}">
                        <a class="nav-link" href="{{ route('admin.frontend.developer.edit') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Developer Section</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item {{ sidenav_active('admin.frontend.howitwork*') }}">
                        <a class="nav-link" href="{{ route('admin.frontend.howitwork.index') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">How It Work</span>
                        </a>
                    </li>
