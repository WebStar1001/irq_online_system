...
@section('panel')
    <!--Dashboard area-->
    <section class="section-padding gray-bg blog-area" style="color:black!important;">
        <div class="container">
    ...
    <div id="enableModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.go2fa.create')}}" method="POST">
    ...
    <div id="disableModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.disable.2fa')}}" method="POST">
                    {{csrf_field()}}
                    <div class="modal-body">
