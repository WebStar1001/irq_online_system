                                    ...
                                    <div class="card outline-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="min_limit" placeholder="0" value="{{$method->single_currency->min_amount}}" />
                                            </div>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="0" name="max_limit" value="{{$method->single_currency->max_amount }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card outline-dark">
                                        ...
                                        <div class="card-body">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="0" name="fixed_charge" value="{{$method->single_currency->fixed_charge}}"/>
                                            </div>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="0" name="percent_charge" value="{{ $method->single_currency->percent_charge}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
