                            ...
                            <div class="form-group">
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="profilePicPreview" style="background-image: url({{ get_image(config('constants.frontend.whychoose.path') .'/'. $testi->value->image) }})">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <small class="mt-2 text-facebook">Supported files: <b>png,</b>. Image will be resized into <b>{{ Config::get('constants.frontend.whychoose.size') }}px</b> </small>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<a href="{{ route('admin.frontend.whychoose.index') }}" class="btn btn-dark" ><i class="fa fa-fw fa-reply"></i>Back</a>
@endpush
