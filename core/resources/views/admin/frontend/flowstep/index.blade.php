                ...
                <table class="table align-items-center table-light">
                    ...
                    <tbody class="list">
                        ...
                        <tr>
                            ...
                            <td>@php echo @$testi->value->icon @endphp</td>
                            <td>{{ description_shortener(@$testi->value->details) }}</td>
                            <td>
                                <a href="{{ route('admin.frontend.flowstep.edit', $testi->id) }}" class="btn btn-rounded btn-primary text-white"><i class="fa fa-fw fa-pencil"></i></a>
...
<a href="{{ route('admin.frontend.flowstep.new') }}" class="btn btn-success"><i class="fa fa-fw fa-plus"></i>Add New</a>
@endpush
